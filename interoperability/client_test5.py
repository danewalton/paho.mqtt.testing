...
class Test(unittest.TestCase):
    ...
    def test_retained_message(self):
      ...
      aclient.publish(topics[3], b"qos 1-1", 1, retained=True, properties=publish_properties)
      time.sleep(1)
      ...
      self.assertTrue(1 in qoss and 1 in qoss and 0 in qoss, qoss)
    ...
    def test_publication_expiry(self):
      ...
      aclient.publish(topics[0], b"qos 1-1 - expire", 1, retained=False, properties=publish_properties)
      ...
      aclient.publish(topics[0], b"qos 1-1 - don't expire", 1, retained=False, properties=publish_properties)
